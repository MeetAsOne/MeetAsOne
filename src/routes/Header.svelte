...
<header>
  <div class="flex items-center justify-evenly w-full py-4">
    ...
    <h2 class="flex gap-5 items-center flex-wrap">
      {#if $page.url.pathname.startsWith("/event")}
        <a href="https://github.com/MeetAsOne/MeetAsOne" target="_blank">Github</a>
        <a href={"https://docs.google.com/forms/d/e/1FAIpQLSf5-yinCVqlVBEU_3AQlN4glPiqySzhms4-wA_Oe0sNBO6iOg/viewform?usp=pp_url&entry.173233276=" + location.pathname.split("/").at(-1)} target="_blank">feedback/issue</a>
      {:else}
